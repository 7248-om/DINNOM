...
const AdminStats = () => {
  const [stats, setStats] = useState({ dailyStats: [], summary: { totalRevenue: 0, totalOrders: 0 } });
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setStats({ dailyStats: formattedData, summary: data.summary });
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Conversion Rate" value="N/A" />
      </div>
