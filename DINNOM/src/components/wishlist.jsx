    ...
    <div className="relative min-h-screen overflow-hidden text-white">
      ...
      <div className="max-w-4xl mx-auto pt-32 pb-12 px-4 flex-1 w-full">
        <div className="flex justify-center mb-10">
          <span className="text-4xl md:text-5xl font-extrabold tracking-widest uppercase bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-transparent drop-shadow-lg"
            style={{
              letterSpacing: '0.2em',
        ...
        {cartItems.length === 0 ? (
          <div className="flex flex-col items-center justify-center mt-20">
            ...
            <Link to="/" className="mt-4 px-8 py-3 bg-white text-black font-bold rounded-full text-lg hover:bg-gray-200 transition shadow">
              Back to Home
            </Link>
          </div>
        ) : (
          <>
            ...
            <div className="flex justify-between items-center mt-10">
              <Link to="/" className="bg-white text-black font-bold px-8 py-4 rounded-full text-lg hover:bg-gray-200 transition shadow">
                Back to Home
              </Link>
      ...
      <div className="w-full bg-white py-6 flex justify-center items-center mt-auto shadow-inner">
        <span className="text-2xl md:text-4xl font-black tracking-[0.35em] text-black uppercase"
          style={{
