...
import fs1 from "../assets/Men/seasonal/fs1.jpg";
import fs2 from "../assets/Men/seasonal/fs2.jpeg";
import fs3 from "../assets/Men/seasonal/fs3.jpg";
import fs4 from "../assets/Men/seasonal/fs4.jpg";

const slides = [
  {
    image: fs1,
    title: "MODERN MANIFESTO",
    subtitle: "TAILORED FUTURISM",
    tagline: "DEFINE YOUR PRESENCE.",
  },
  {
    image: fs2,
    title: "ICONIC CHIC",
    subtitle: "LUXURY LEATHER ESSENTIALS",
    tagline: "EFFORTLESSLY BOLD.",
  },
  {
    image: fs3,
    title: "NIGHT MOVES",
    subtitle: "THE REBEL JACKET",
    tagline: "OWN THE STREETS.",
  },
  {
    image: fs4,
    title: "URBAN PULSE",
    subtitle:  "THE EVERYDAY STATEMENT",
